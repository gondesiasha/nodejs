...
var startswithz=names.filter(function(name){
    return name[0]=="z";
});
console.log(startswithz);
console.log(startswithz.length);
// How many baby names have the letter 'z' in them anywhere?


var zinanywhere=names.filter(function(name){
    return name.indexOf("a")!=-1;
});
console.log(zinanywhere);
console.log(zinanywhere.length);

 //Create a new array that contains all of the names containing a 'w' with the
//first letter upper-case.
var wuppercase=names.filter(function(name){
    return name.indexOf("w")!=-1;
}).map(function(wuppercase){
    return wuppercase[0].toUpperCase()
    +wuppercase.slice(1);

});
console.log(wuppercase);


// Do all of the names contain vowels?
var vowels=names.every(function(name){
    return ((name.indexOf("a")!=-1)||(name.indexOf("e")!=-1)||(name.indexOf("i")!=-1)||(name.indexOf("o")!=-1)||(name.indexOf("u")!=-1))
});
console.log(vowels);

 //Are there any names that have only two letters?
 var twoletters=names.filter(function(name){
return name.length==2;
 });
 console.log(twoletters);
 //Is your name in the list?
 var myname=names.some(function(name){
return name=="asha";
 });
 console.log(myname);
 //Find the name that would come first alphabetically.

 var alphabetically=names.reduce(function(name1,name2){
    if(name2<name1)
    {
        name1=name2;
 ...
 var ztimes=names.filter(function(name){
    var c=0;
    if(name.match(/a/g))
    {
        c++;
...
console.log(names[s.indexOf(Math.max(...s))]);
